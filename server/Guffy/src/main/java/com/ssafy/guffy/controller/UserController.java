...
public class UserController{
     ...
     * @GetMapping("")
     * 
     * @ApiOperation(value = "해당 email을 가진 사용자 정보를 반환한다.") public User
     * select(@RequestParam String email) { return service.select(email); }
     */
    ...
    public String create(@RequestBody User user) {
        if (service.select(user.getEmail())== null) {
